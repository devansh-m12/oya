    ...
    <div className={cls("flex gap-3", isUser ? "justify-end" : "justify-start")}>
      ...
      <div
        className={cls(
          ...
          isUser
            ? "bg-zinc-900/95 text-white dark:bg-white/95 dark:text-zinc-900"
            : "bg-white/95 text-zinc-900 dark:bg-zinc-900/95 dark:text-zinc-100 border border-zinc-200/50 dark:border-zinc-800/50",
        )}
      >
        {renderContent()}
        {children}
